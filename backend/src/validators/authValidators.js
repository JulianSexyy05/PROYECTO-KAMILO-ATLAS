...
export const registerValidators = [
  ...
  body("password").isLength({ min: 8 }).withMessage("La contraseña debe tener al menos 8 caracteres.").isLength({ max: 100 }).withMessage("La contraseña no puede superar 100 caracteres."),
